...
### 🏎️ The Arsenal: First Principles Architecture
...
* **Frontend:** Blazor WebAssembly, Microsoft Fluent UI, ApexCharts
* **Backend:** C#, .NET 9, Azure Functions (Isolated Worker Model)
* **Data:** SQL Server, T-SQL, Dapper, Microsoft Fabric
* **Cloud & DevOps:** Azure Static Web Apps, GitHub Actions, Microsoft Entra ID
...
---
### 🔗 Let's Connect
* 🌐 **Website:** [DanMarr.co](https://www.danmarr.co)
* ✍️ **Blog:** [DanMarr.co: unscripted](https://blog.danmarr.co)
* 👔 **LinkedIn:** [Dan Marr](https://www.linkedin.com/in/danmarrco)
